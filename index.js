...
let workItems = ["Show Up", "Clock In", "Take Lunch"];
// create new array for fun items
let funItems = ["Watch TV", "Read a Book", "Go to the Beach"];

let weekendItems = ["Watch Football", "Go Shopping", "Take a Nap"];
...
// display weekend to do list on the localhost:3000/work route!
